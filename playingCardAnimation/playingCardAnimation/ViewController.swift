...
/* FOR SHOWING ONE CARD
 ...
 let pinch = UIPinchGestureRecognizer(target: playCardView, action: #selector(playCardView.adjustFaceCardScale(by:)))
 ...
 switch sender.state{
 case .ended: playCardView.isFaceUp = !playCardView.isFaceUp
 default: break
 }
